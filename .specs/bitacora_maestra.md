...
- **Implementación de Nombre de Propietario Real (Nombre de Propietario):**
  - **Base de Datos:** Modificado `schema.prisma` para incluir el campo opcional `name` en el modelo `User` y ejecutada la migración de base de datos a producción mediante `npx prisma db push`.
